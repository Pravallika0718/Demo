		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#capgroute301221-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capgroute301221-display": {
								"semanticObject": "capgroute301221",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capg.route301221",
									"url": sap.ui.require.toUrl("capg/route301221")
								}
							}
						}
					}
